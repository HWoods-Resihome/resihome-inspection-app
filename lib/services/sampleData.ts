...
export const SAMPLE_SERVICES: SampleService[] = [
  { id: 'S-1041', scope: 'property',  address: '935 River Glen Pl',  locality: 'Riverdale, GA 30296', portfolio: 'Amherst Sunbelt', region: 'GA: Atlanta',  worktype: 'grass_cut',      status: 'estimated',   propertyStatus: 'Vacant',           vendor: 'GreenBlade Lawn Co.', dueDate: '2026-07-22' },
  { id: 'S-1042', scope: 'property',  address: '7558 Woodbine Pl',   locality: 'Riverdale, GA 30296', portfolio: 'Amherst Sunbelt', region: 'GA: Atlanta',  worktype: 'grass_cut',      status: 'assigned',  propertyStatus: 'Pending MOI/Rekey', vendor: 'GreenBlade Lawn Co.', dueDate: '2026-07-19' },
  { id: 'S-1043', scope: 'property',  address: '412 Camden Loop',    locality: 'Atlanta, GA 30331',   portfolio: 'Tricon GA',       region: 'GA: Atlanta',  worktype: 'pool_service',   status: 'submitted', propertyStatus: 'Vacant',           vendor: 'AquaPro Pools',       dueDate: '2026-07-17' },
  { id: 'S-1044', scope: 'property',  address: '88 Harlow Trace',    locality: 'Marietta, GA 30060',  portfolio: 'Tricon GA',       region: 'GA: Atlanta',  worktype: 'grass_cut',      status: 'review',   propertyStatus: 'Vacant',           vendor: 'Metro Cut LLC',       dueDate: '2026-07-15' },
  { id: 'S-1045', scope: 'property',  address: '2201 Stone Manor Ct',locality: 'Lithonia, GA 30058',  portfolio: 'Progress',        region: 'GA: Atlanta',  worktype: 'house_cleaning', status: 'completed',   propertyStatus: 'Occupied',         vendor: 'Peachtree Grounds',   dueDate: '2026-07-11', onTime: true },
  { id: 'S-1046', scope: 'community', address: 'Woodbine Crossing',  locality: 'Riverdale, GA 30296', community: 'Woodbine Crossing', portfolio: 'Amherst Sunbelt', region: 'GA: Atlanta', worktype: 'grass_cut',    status: 'estimated',   vendor: 'GreenBlade Lawn Co.', dueDate: '2026-07-24' },
  { id: 'S-1047', scope: 'community', address: 'River Glen',         locality: 'Riverdale, GA 30296', community: 'River Glen',        portfolio: 'Amherst Sunbelt', region: 'GA: Atlanta', worktype: 'grass_cut',  status: 'assigned',  vendor: 'Peachtree Grounds',   dueDate: '2026-07-20' },
  { id: 'S-1048', scope: 'community', address: 'Camden Pointe',      locality: 'Columbus, GA 31904',  community: 'Camden Pointe',     portfolio: 'Tricon GA',       region: 'GA: Columbus', worktype: 'house_cleaning', status: 'submitted', vendor: 'Metro Cut LLC',       dueDate: '2026-07-16' },
  { id: 'S-1049', scope: 'community', address: 'Harlow Trace',       locality: 'Columbus, GA 31909',  community: 'Harlow Trace',      portfolio: 'Progress',        region: 'GA: Columbus', worktype: 'grass_cut',  status: 'review',   vendor: null,                  dueDate: '2026-07-16' },
