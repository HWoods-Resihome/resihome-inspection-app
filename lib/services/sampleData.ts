...
export const SAMPLE_SERVICES: SampleService[] = [
  ...
  { id: 'S-1045', scope: 'property',  address: '2201 Stone Manor Ct',locality: 'Lithonia, GA 30058',  portfolio: 'Progress',        region: 'GA: Atlanta',  worktype: 'cleaning',    subtype: 'vacant_clean',  status: 'completed',   propertyStatus: 'Occupied',         vendor: 'Peachtree Grounds',   dueDate: '2026-07-11', completedAt: '2026-07-11T14:30:00Z', onTime: true, lat: 33.712, lng: -84.105 },
  ...
  { id: 'S-1051', scope: 'property',  address: '640 Oakvale Rd',     locality: 'Decatur, GA 30032',   portfolio: 'Amherst Sunbelt', region: 'GA: Atlanta',  worktype: 'landscaping', subtype: 'cut',          status: 'completed',   propertyStatus: 'Occupied', vendor: 'GreenBlade Lawn Co.', dueDate: '2026-07-04', completedAt: '2026-07-04T09:15:00Z', onTime: true, lat: 33.772, lng: -84.281 },
  { id: 'S-1052', scope: 'property',  address: '77 Pinehurst Way',   locality: 'Columbus, GA 31904',  portfolio: 'Tricon GA',       region: 'GA: Columbus', worktype: 'pools',       subtype: 'pool_cleaning', status: 'completed',   propertyStatus: 'Occupied', vendor: 'AquaPro Pools',       dueDate: '2026-07-02', completedAt: '2026-07-02T11:45:00Z', onTime: false, lat: 32.505, lng: -84.995 },
];
