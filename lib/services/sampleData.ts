...
export const SAMPLE_SERVICES: SampleService[] = [
  { id: 'S-1041', scope: 'property',  address: '935 River Glen Pl',  locality: 'Riverdale, GA 30296', portfolio: 'Amherst Sunbelt', region: 'GA: Atlanta',  worktype: 'grass_cut',      status: 'scheduled',   propertyStatus: 'Vacant',           vendor: 'GreenBlade Lawn Co.', dueDate: '2026-07-22' },
  { id: 'S-1042', scope: 'property',  address: '7558 Woodbine Pl',   locality: 'Riverdale, GA 30296', portfolio: 'Amherst Sunbelt', region: 'GA: Atlanta',  worktype: 'grass_cut',      status: 'dispatched',  propertyStatus: 'Pending MOI/Rekey', vendor: 'GreenBlade Lawn Co.', dueDate: '2026-07-19' },
  { id: 'S-1043', scope: 'property',  address: '412 Camden Loop',    locality: 'Atlanta, GA 30331',   portfolio: 'Tricon GA',       region: 'GA: Atlanta',  worktype: 'pool_service',   status: 'in_progress', propertyStatus: 'Vacant',           vendor: 'AquaPro Pools',       dueDate: '2026-07-17' },
  { id: 'S-1044', scope: 'property',  address: '88 Harlow Trace',    locality: 'Marietta, GA 30060',  portfolio: 'Tricon GA',       region: 'GA: Atlanta',  worktype: 'grass_cut',      status: 'submitted',   propertyStatus: 'Vacant',           vendor: 'Metro Cut LLC',       dueDate: '2026-07-15' },
  ...
  { id: 'S-1050', scope: 'property',  address: '19 Maple Run Dr',    locality: 'Decatur, GA 30032',   portfolio: 'Progress',        region: 'GA: Atlanta',  worktype: 'grass_cut',      status: 'scheduled',   propertyStatus: 'Vacant',   vendor: null,                  dueDate: '2026-07-26' },
