  ...
  try {
    ...
    for (const u of upserts) {
      ...
      const props: Record<string, any> = {
        ...
        question_text: line.customLaborFullDescription || catalog.laborShortDescription,
        answer_value: catalog.laborShortDescription,
        note: line.note || '',
        ...
        // Inspector overrides (raw inputs, so we can reload + pre-populate the
        // form). Cleared when blank — HubSpot accepts '' to unset numbers.
        custom_labor_rate: line.customLaborRate != null ? line.customLaborRate : '',
        custom_adjusted_material_cost: line.customAdjustedMaterialCost != null ? line.customAdjustedMaterialCost : '',
        custom_vendor_cost: line.customVendorCost != null ? line.customVendorCost : '',
    ...
    // TEMPORARY DIAGNOSTIC LOGGING — remove once save bug is identified.
    console.log('[rate-card-lines] SAVE OK', {
      inspectionRecordId,
