    ...
    <div className="border-t border-gray-100 pt-4">
      ...
      {attached ? (
        <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2.5">
          <div className="flex items-center gap-2 min-w-0 text-[13px] font-semibold text-emerald-800">
          ...
          <button type="button" onClick={() => onChange('', '')} className="block text-[12px] font-semibold text-gray-500 hover:text-red-600 mt-1.5">Remove</button>
        </div>
      ) : (
