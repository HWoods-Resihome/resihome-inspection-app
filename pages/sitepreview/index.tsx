 ...
 *
 * Faithful port of the approved "enterprise redesign" (Oswald display + Raleway,
 * pink #FF0066 / ink / aqua) into a Next page, with three additions wired in:
 *   1. the intro VIDEO stays on the page,
 *   2. the contact form actually POSTs to /api/sitepreview/contact (emails the team),
 *   3. real photo slots ("In the field") that load /sitepreview/photos/*.jpg and
