...
const FAQS: { q: string; a: string }[] = [
  ...
  { q: 'Which inspection types are supported?', a: 'Scope Rate Card, 1099 Leasing-Agent Property Inspection, Turn Re-Inspect QC, Vacancy/Occupancy Check, Community/Visit, and New-Construction RRQC. Templates are configurable per program, and the field app works fully offline — queued work syncs automatically when signal returns.' },
