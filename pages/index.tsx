          ...
          <div className="lz-head max-w-3xl mx-auto px-4 pt-2 pb-2.5">
            <div className="flex items-center justify-between gap-3 mb-2.5">
              ...
              <div className="flex items-center gap-3 whitespace-nowrap">
                ...
                {/* Admin tools — gear to the RIGHT of Sign Out, opening a popover
                    (keeps the admin links out of the header's vertical space). */}
                {isAdmin && (
                    ...
                    {settingsOpen && (
                      <>
                        ...
                        <div className="absolute right-0 mt-1.5 z-50 w-52 rounded-xl border border-gray-200 bg-white shadow-lg ring-1 ring-black/5 overflow-hidden py-1">
                          <Link href="/ai-knowledge" onClick={() => setSettingsOpen(false)} className="flex items-center gap-2.5 px-3.5 py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition-colors">
