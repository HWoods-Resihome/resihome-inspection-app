        ...
        <td colSpan={12} className="p-0">
          <div className="fixed inset-0 z-50 bg-black/40 flex items-end sm:items-center sm:justify-center">
            <div data-modal-scroll className="bg-white w-full sm:max-w-md sm:rounded-2xl rounded-t-2xl max-h-[92vh] overflow-y-auto shadow-xl">
              {/* Sticky header with title + clear (eraser) + close */}
              <div className="sticky top-0 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between z-10">
                ...
                <div className="flex items-center gap-1">
                  <button
                    type="button"
                    onClick={clearLine}
                    className="text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-lg w-8 h-8 flex items-center justify-center"
                    title="Clear the form (wipe all fields)"
                    aria-label="Clear form"
                  >
                    {/* eraser icon (not a pencil) */}
