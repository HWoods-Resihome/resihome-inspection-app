            ...
            <section key={inst.instanceKey} id={sectionDomId} className="mb-8 scroll-mt-24">
              ...
              >
                ...
                <div className="flex items-center gap-2 shrink-0 ml-3">
                  {/* Photo-needed badge: only shown when section is collapsed.
                      When expanded, the inline "photo needed" italic on the title
                      and the amber section-photo panel already make this clear. */}
                  {photosMissing && isCollapsed && (
                    <span
                      className="inline-flex items-center gap-1 text-xs bg-amber-400 text-amber-950 font-heading font-bold px-2 py-0.5 rounded-full"
