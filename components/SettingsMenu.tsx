              ...
              <>
                ...
                {expanded['tools'] && (
                  <>
                    ...
                    {/* Renders server HTML (form + result), so a plain anchor in a
                        new tab — not a client-side Link. */}
                    <a href="/api/admin/ticket-type-test" target="_blank" rel="noopener noreferrer" onClick={() => setOpen(false)} className={groupRowCls}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-gray-400 shrink-0"><path d="M9 11l3 3L22 4" /><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" /></svg>
                      Ticket Type Test
                    </a>
